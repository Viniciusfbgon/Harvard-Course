...
def buy():
    ...
    if request.method == "POST":
        ...
        item_name = item.get('name', 'Default Name')
...
def sell():
    ...
    if request.method == "POST":
        ...
        if lookup_result is None:
            return apology("enter a symbol subscritable")
        else:
            item_price = lookup_result["price"]
            item_name = lookup_result.get("name", "Default Name")

        item_price = lookup(symbol)["price"]
        item_name = lookup(symbol).get("name", "Default Name")
