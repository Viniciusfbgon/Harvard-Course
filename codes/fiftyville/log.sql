...
SELECT caller, caller.name, receiver, receiver_name FROM phone_calls
WHERE year = 2023
AND month = 7
AND day = 28
AND duration < 60;
...
JOIN passengers ON people.passaport_number = passengers.passaport_number
...
JOIN passengers ON people.passaport_number = passengers.passaport_number
JOIN flights ON flights.id = passengers.flights_id
